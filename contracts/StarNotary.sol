...
contract StarNotary is ERC721 {
    ...
    string public name = "Kaal Star Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerAddress1 || msg.sender == ownerAddress2, "You must own one of the stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), 'You need to own the star');
